## Documentação 'Transaction Query MII': GetParamMedidorLaboratorioSelectQuery.tqsq
...
|    | DML    | Target                 |
|---:|:-------|:-----------------------|
|  0 | SELECT | MES_MEDIDORLABORATORIO |
<br><br>
...
Script Query: 
```sql
select IdExistencia,Codg_Grupo, Codg_Amostra, Codg_SubAmostra, Nome_Elemento, Desc_Unidade 
from mes_medidorlaboratorio 
where idexistencia = [Param.1]
